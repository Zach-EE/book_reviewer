    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='The Title of Book or Article', max_length=70)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_names', models.CharField(help_text="Contributor's first names", max_length=50)),
                ('last_names', models.CharField(help_text="Contributor's last names", max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(help_text='The book review was for.', on_delete=django.db.models.deletion.CASCADE, to='reviews.book')),
